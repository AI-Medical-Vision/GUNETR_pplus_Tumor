...
class unetr_pp_trainer_synapse(Trainer_synapse):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.max_num_epochs = 1000 # 1000 -> 5000
        self.initial_lr = 1e-2 #5e-4
        ...
        self.crop_size = [64, 128, 128] # [64, 128, 128]
    ...
    def initialize_network(self):
        ...
        self.network = UNETR_PP(in_channels=self.input_channels,
                             ...
                             feature_size=16, # 16 -> 32
                             num_heads=4,
                             depths=[3, 3, 3, 3],
                             dims=[32, 64, 128, 256], # [32, 64, 128, 256] -> [64, 128, 256, 512]
                             #dims=[64, 128, 128, 256], # 1,4,4,4,256
                             do_ds=True,
                             )
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        ret = super().validate(do_mirroring=do_mirroring, use_sliding_window=use_sliding_window, step_size=step_size,
                               ...
                               run_postprocessing_on_folds=run_postprocessing_on_folds, data_name=data,
                                extension=extension)
    ...
    def do_split(self):
        ...
        """
        if self.fold == "all":
            # if fold==all then we use all images for training and validations
    ...
    def setup_DA_params(self):
        ...
        #print("deep scales:", self.deep_supervision_scales) # deep scales: [[1, 1, 1], [0.5, 0.25, 0.25], [0.25, 0.125, 0.125]]
        #self.deep_supervision_scales = [[1,1,1], [1/3, 1/3, 1/3], [1/6, 1/6, 1/6]]
        ...
        #print("#############################################")
        #print("patch_size:", patch_size_for_spatialtransform)
