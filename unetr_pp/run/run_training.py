...
def main():
    ...
    parser.add_argument('-pretrained_weights', type=str, required=False, default='./output_synapse/3d_fullres/Task002_Synapse/unetr_pp_trainer_synapse__unetr_pp_Plansv2.1/fold_0/model_best.model', #'./output_synapse/3d_fullres/Task002_Synapse/unetr_pp_trainer_synapse__unetr_pp_Plansv2.1/fold_0/model_final_checkpoint.model',
    ...
    if find_lr:
        ...
        if not validation_only:
            if False: #args.continue_training:
        ...
        if data in ['3Dircadb', 'LiTS', 'Sliver']:
            ...
            trainer.validate(save_softmax=args.npz, validation_folder_name=val_folder,
                            ...
                            overwrite=args.val_disable_overwrite, data=data, extension=extension)
