...
class UnetrPPEncoder(nn.Module):
    ...
    #def __init__(self, input_size=[16 * 16 * 16, 8 * 8 * 8, 4 * 4 * 4, 2 * 2 * 2], dims=[16, 32, 64, 128],
        ...
        stem_layer = nn.Sequential(
            #get_conv_layer(spatial_dims, in_channels, dims[0], kernel_size=(2,4,4), stride=(2,4,4), # kernel_size and stride (2, 4, 4)
